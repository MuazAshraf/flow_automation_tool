...
// VeoFlow Logo - Clean modern design with parrot green accent
const LogoIcon = () => (
  <svg width="36" height="36" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
    <rect width="100" height="100" rx="20" fill="#56CC38"/>
  ...
  return (
    <div className="flex items-center justify-between p-4 border-b border-gray-800 bg-black">
      <div className="flex items-center gap-3">
        <LogoIcon />
        <div>
          <h1 className="text-lg font-bold text-white">VeoFlow</h1>
          <p className="text-xs text-gray-400">Bulk Video Automation</p>
        </div>
      </div>
